...
/* Logo */
/* Increased Logo Size & Alignment */
.nav-logo {
  display: flex;
  align-items: center;
  gap: 15px; /* Slightly more space between logo and tagline */
  padding: 10px 0; /* Vertical breathing room */
}

.nav-logo-img {
  /* This is the main control for your logo size */
  height: 65px; 
  width: auto;
  object-fit: contain;
  display: block;
...
@media (max-width: 768px) {
  .nav-logo-img {
    height: 48px; /* Compact for mobile header */
  }
  .logo-sub {
    display: none; /* Often cleaner to hide sub-text on mobile logos */
  }
}
...
/* Align Logo Image alongside the sub-tagline */
.nav-logo {
  display: flex;
  align-items: center;
  gap: 12px; /* Space between logo image and tagline text */
}

.nav-logo-img {
  height: 50px; /* Adjust height to fit your navbar cleanly */
  width: auto;
  object-fit: contain;
  display: block;
}
...
@media (max-width: 768px) {
  .nav-logo-img {
    height: 40px; /* Slightly smaller for mobile views */
  }
}
...
<nav class="navbar">
  <div class="nav-inner">
    <a href="index.html" class="nav-logo">
      <img src="/logo.png" alt="mamateenaija logo" class="nav-logo-img">
      <div class="logo-text-wrap">
        <span class="logo-sub">mamateetastykitchen Cuisine · UK</span>
      </div>
    </a>
...
<footer class="footer"><div class="footer-inner"><p class="footer-copy">copywrite by mamateenaija &copy; 2025</p><nav class="footer-links"><a href="#">Shipping Policy</a><a href="#">Shop Policy</a><a href="contact.html">Contact Us</a></nav><div class="footer-socials"><a href="#"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg></a><a href="#"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a></div></div></footer>
...
<footer class="footer">
  <div class="footer-inner">
    <p class="footer-copy">copywrite by mamateenaija &copy; 2025</p>
...
<link rel="apple-touch-icon" href="/logo.png">
  <style>
    /* HOME — splits into portrait photo left, logo+CTA right, like mamateetastykitchen */
    
    /* HOME HERO — Full width background like mamateetastykitchen */
.home-main {
  position: relative;
...
/* Red "Order Now" Badge */
.order-now-badge {
  background-color: #e33e2b; /* Bright red from pic */
  color: white;
  padding: 10px 24px;
  border-radius: 8px;
  font-weight: 600;
...
.home-logo-text {
  font-family: var(--ff-serif);
  font-size: clamp(3rem, 10vw, 6rem); /* Scales with screen size */
  font-weight: 700;
  line-height: 0.9;
  margin-bottom: 10px;
  /* Specific "9" color styling to match logo if desired */
  color: var(--white);
}

/* Highlight the 'tasty' or specific letters like the logo */
...
/* Matching the Green and Orange buttons from the pic */
.btn-pickup {
  background-color: #1e854a; /* Nigerian Green */
  color: white;
  border-radius: 8px;
  font-weight: 600;
  min-width: 200px;
...
.btn-delivery {
  background-color: #f4821f; /* Orange */
  color: white;
  border-radius: 8px;
  font-weight: 600;
  min-width: 200px;
...
.home-btns {
  opacity: 0;
  animation: fadeInUp 0.8s ease-out 1.2s forwards; /* Delayed until text finishes typing */
}

/* Typewriter Cursor Effect */
.typewriter {
  display: inline-block;
  border-right: 3px solid #00a859; /* Green cursor */
  white-space: nowrap;
  overflow: hidden;
}
...
/* Mobile Adjustments */
@media (max-width: 768px) {
  .home-main { min-height: 60vh; }
  .home-btns { flex-direction: column; align-items: center; gap: 12px; }
  .btn-pickup, .btn-delivery { width: 100%; max-width: 280px; }
  .home-tagline { font-size: 0.8rem; letter-spacing: 0.15em; }
}
  </style>
</head>
<body>
...
<!-- HOME HERO — two-column like mamateetastykitchen -->
<main class="home-main">
  <div class="home-content">
    
    <div class="order-now-badge">Order Now!</div>

    <h1 class="home-logo-text">
      <span id="type-title" class="typewriter cursor-blink"></span>
    </h1>

    <p class="home-tagline">
      <span id="type-tagline" class="typewriter"></span>
    </p>

    <div class="home-btns">
      <a href="pickup.html" class="btn btn-pickup">Order For Pickup</a>
      <a href="category.html" class="btn btn-delivery">Order For Delivery</a>
    </div>
...
<script>
document.addEventListener('DOMContentLoaded', () => {
    const titleText = "mamateetastykitchen";
    const taglineText = "Authentic tasty Cuisine";
    ...
    function typeEffect(element, text, speed, callback) {
        ...
        // Add specific green color to "kitchen" part of the string
        const renderText = () => {
            if (i < text.length) {
                let char = text.charAt(i);
                
                // Logic to highlight "kitchen" in green like your original HTML
                if (text === titleText && i >= 13) {
                   element.innerHTML += `<span class="text-green">${char}</span>`;
                } else {
    ...
    // Start typing: Title first, then tagline
    typeEffect(titleElement, titleText, 70, () => {
        taglineElement.classList.add('cursor-blink');
        typeEffect(taglineElement, taglineText, 50);
    });
});
</script>
</body>
